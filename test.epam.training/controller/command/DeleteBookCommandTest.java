...
import by.training.homework6.controller.command.impl.DeleteBookCommand;
...
public class DeleteBookCommandTest {
    ...
    public void executeTestValid() {
        try {
            String idToDelete = dataTest.takeBookLibraryTest().getBooks().get(0).getId();
            Map<String, String> expected = new HashMap<>();
            expected.put("SUCCESSFUL DELETING", "BOOK WAS DELETED");
            Map<String, String> actual = delete.execute(idToDelete);
